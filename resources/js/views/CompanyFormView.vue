            ...
            <div class="-space-y-px rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <input id="address" v-model="address"
                           class="relative block w-full rounded-b-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Address">
                </div>
                <div>
                    <label for="zip_code" class="sr-only">Zip code</label>
                    <input id="zip_code" v-model="zip_code"
                           class="relative block w-full rounded-b-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Zip code">
                </div>
            </div>
            <div>
