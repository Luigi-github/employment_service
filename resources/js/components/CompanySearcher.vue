    ...
    <form @submit.prevent="handleSubmit" autocomplete="off" novalidate class="flex flex-row mb-5">
        ...
        <div class="pl-5 mt-8 bg-white">
            <div class="text-right">
                ...
                <a href="/companies/0" class="inline-flex justify-center rounded-md bg-indigo-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 ml-5">Crear nuevo</a>
            </div>
        </div>
    </form>
</template>
